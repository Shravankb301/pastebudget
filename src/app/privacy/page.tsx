...
export const metadata: Metadata = {
  title: "Privacy",
  description: "How PromptFit handles prompts, files, browser storage, and analytics.",
    ...
    <main className="min-h-screen bg-[#f7f5f1]">
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
        ...
        <p className="mt-5 text-lg leading-8 text-stone-600">
          PromptFit is designed so the sensitive part of the product—the material you measure—does not need a backend.
        </p>
        ...
        <div className="mt-12 space-y-10 border-t border-stone-300 pt-10 text-stone-700">
          <section>
            ...
            <p className="mt-3 leading-7">
              Text you paste and files you choose are read in your browser tab. Token counting and chunking run there too. PromptFit does not upload, store, log, or transmit their contents. Closing or refreshing the tab clears the working material.
            </p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-stone-950">Browser storage</h2>
            <p className="mt-3 leading-7">
              PromptFit does not put prompt text or file contents in local storage, IndexedDB, cookies, or a service worker cache. The application code and static pages may be cached normally by your browser or hosting provider.
            </p>
          </section>
          <section>
